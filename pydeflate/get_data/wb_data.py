...
class WB(Data):
    ...
    def get_indicator(self, indicator: Union[str, None] = None) -> pd.DataFrame:
    ...
    def get_usd_exchange(self) -> pd.DataFrame:
        ...
        # get exchange rates
        df = self.get_indicator(indicator="PA.NUS.FCRF")
    ...
    def get_euro2usd(self) -> dict:
        """Dictionary of EUR to USD exchange rates"""

        return self.get_exchange2usd_dict(currency_iso="EMU")

    def get_can2usd(self) -> dict:
        """Dictionary of CAN to USD exchange rates"""

        return self.get_exchange2usd_dict(currency_iso="CAN")

    def get_gbp2usd(self) -> dict:
        """Dictionary of GBP to USD exchange rates"""

        return self.get_exchange2usd_dict(currency_iso="GBR")
    ...
    def get_xe_deflator(
        ...
        """get exchange rate deflator based on WB base year and exchange rates"""
