...
To install pydeflate, run this command in your terminal:
...
The sources for pydeflate can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/jm-rivera/pydeflate
.. _tarball: https://github.com/jm-rivera/pydeflate/tarball/master
